    ...
    <div class="mb-4">
        <div class="flex items-center sm:flex-row flex-col w-full gap-4">
            ...
            <div wire:loading class="flex items-center">
                <svg class="animate-spin h-8 w-8 text-gray-200 dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101"
                ...
                <span class="ml-1 text-gray-200 sr-only">Loading...</span>
            </div>
        </div>
    </div>
            ...
            <div wire:loading
                ...
                <div class="flex items-center justify-center h-full">
                    <div class="flex justify-center items-center flex-col gap-2">
                        ...
                        <span class="text-gray-200">Loading more...</span>
                    </div>
                </div>
            </div>
        </div>
