                ...
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-4">
                    ...
                    <div class="relative">
                        ...
                        <span id="toggle-password"
                            class="absolute top-8 right-2 flex items-center text-gray-600 cursor-pointer justify-center">👁️</span>
                        @error('password')
                            <div class="text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="flex items-center justify-between sm:flex-row flex-col">
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="text-gray-400">Keep me connected</label>
                        </div>
                    ...
                    <button type="submit"
                        class="w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition duration-200">Login</button>
                </form>
